...
public class objetosEncontradosFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_objetos_encontrados, container, false);

        gridView = view.findViewById(R.id.gvObjetosEncontrados);
        pb = view.findViewById(R.id.progressBarFragmentoEncontrado);
        ...
        btnActualizarGV = (Button) view.findViewById(R.id.btnActualizarGVOE);

        mostrarFiltros();

        // Verificar si los datos ya se cargaron previamente en el ViewModel
        List<Publicacion> publicaciones = viewModel.getPublicacionesObjEncontrado();
    ...
    public void cargarGridView(){
        ...
        filtro = " Estado = 1 AND ID_TipoPublicacion = 2 AND Recuperado = 0";
        if (pb.getVisibility() == View.INVISIBLE) {
            pb.setVisibility(View.VISIBLE);
        }
        gridView.setAdapter(null);
        PublicacionDao publicacionDao = new PublicacionDao(requireContext(), gridView,2);
